...
class Navbar extends Component {
  ...
  render() {
    return (
      ...
      <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center bg-green-500" style={{ background: theme.ui, color: theme.syntax }}>
      <a class="flex title-font font-medium items-center text-white-900 mb-4 md:mb-0"><span class="ml-3 text-xl">ContextApp</span></a>
        ...
        <div class="mr-5 hover:text-white-900" onClick={() => toggleAuth()}>
